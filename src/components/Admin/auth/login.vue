    ...
    <section class="div-login">
      <div class="rounded p-2 bg-light form-sign">
        <div class="d-flex flex-column justify-content-center align-items-center">
          ...
          <h1 class="fs-1 fw-bold mt-4" style="color: #000336">Log In Like Admin</h1>
...
export default {
  ...
  methods: {
    async submitForm() {
      ...
      try {
        const res_log_in = await axios.post(this.api.baseUrl + this.api.endPoint.admin.auth.login, AdminData);
